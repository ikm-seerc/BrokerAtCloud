package org.wso2.custom.internal.serviceDeprecation.handler;
...
import org.apache.axiom.om.util.AXIOMUtil;
import org.seerc.handlers.service.ServiceDeprecation;
import org.wso2.carbon.registry.core.jdbc.handlers.filters.URLMatcher;

public class Activator implements BundleActivator {
	private ServiceDeprecation handler;
	...
	public void start(final BundleContext bundleContext) throws Exception {
		...
		handler = new ServiceDeprecation();
		...
		filterPropertyData = "/brokerAtCloud/serviceDescriptions/.*";
